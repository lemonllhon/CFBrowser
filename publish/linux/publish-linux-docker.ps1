...
try {
    ...
    $builderImage = "trace-browser-linux-builder:local"
    ...
    $npmCacheVolume = "trace-browser-linux-npm-cache"
    $nodeModulesVolume = "trace-browser-linux-node-modules-$linuxArch"
    $goModCacheVolume = "trace-browser-linux-go-mod-cache"
    $goBuildCacheVolume = "trace-browser-linux-go-build-cache"
